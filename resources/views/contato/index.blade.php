            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- delete the contato (uses the destroy method DESTROY /contatos/{id} -->
                        <!-- we will add this later since its a little more complicated than the other two buttons -->
                        {{ Form::open(array('url' => 'contato/' . $value->id, 'class' => 'pull-right')) }}
                             {{ Form::hidden('_method', 'DELETE') }}
                             {{ Form::submit('Detetar esse contato', array('class' => 'btn btn-warning')) }}
                        {{ Form::close() }}

                        <!-- show the contato (uses the show method found at GET /contatos/{id} -->
                        <a class="btn btn-small btn-success" href="{{ URL:: to('contato/' . $value->id) }}">Mostrar esse contato</a>

                        <!-- edit this contato (uses the edit method found at GET /contatos/{id}/edit -->
